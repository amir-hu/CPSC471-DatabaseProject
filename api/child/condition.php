...
if (empty($childSIN)) {
    ...
    echo 'Unable to get conditions. Data is incomplete.';
...
// Check data type
    ...
    echo 'Unable to get conditions. Data type is not correct.';
 ...
 // Make sure that the input length matches model
    ...
    echo 'Unable to get condtions. Data does not match the defined model.';
    ...
    try {
        ...
        http_response_code(400);
        echo "Unable to get conditions. " . $exception->getMessage();
    }
}
?>